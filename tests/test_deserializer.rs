...
#[test]
fn test_deserialize_allinone() -> DeserializerResult {
    let bytes = [
...
#[test]
fn test_deserialize_vardemo() -> DeserializerResult {
    let bytes = [
...
#[test]
fn test_deserialize_throwsdemo() -> DeserializerResult {
    let bytes = [
...
#[test]
fn test_deserialize_linenumberdemo() -> DeserializerResult {
    let bytes = [
...
#[test]
fn test_deserialize_interface_demo() -> DeserializerResult {
    let bytes = [
...
#[test]
fn test_deserialize_implements_demo() -> DeserializerResult {
    let bytes = [
